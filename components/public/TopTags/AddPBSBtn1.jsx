    ...
    render() {
        const menu = (
            <Menu onClick={this.handleClick}>
                    <Menu.Item  key="1" onClick={this.props.onClickHandle.bind(this,"AddPBSBtn" ,'新增同级PBS')}>
                        <a href="#">新增同级PBS</a>
                    </Menu.Item>
                    <Menu.Item  key="2" onClick={this.props.onClickHandle.bind(this,"AddPBSBtn" , '新增下级PBS')}>
                        <a href="#">新增下级PBS</a>
                    </Menu.Item>
            </Menu>
        );
