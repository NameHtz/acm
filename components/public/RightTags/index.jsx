...
import { Menu, Dropdown, Icon, Spin, message, notification } from 'antd';
...
class TopTags extends React.Component {
	constructor(props) {
		...
		//     if(storeState.rightData.title == '' || this.props.name == storeState.rightData.title) {
		//         this.setInfo(storeState.rightData.rightTag, storeState.rightData.data)
		//         if(storeState.rightData.title == '') {
		//             this.closeRightBox()
		//         }
		//     }
		// })
		...
		function onmousemove(pad, e) {
			...
			if (type) {
				...
				if ((widowsWidth - event.clientX - 50) < 400) {
					...
					// console.log(widowsWidth, widowsWidth - event.clientX - 50, widowsWidth - 100);
