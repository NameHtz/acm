...
class LogDistribute extends Component {
    ...
    render() {
        ...
        return (
            <div >
                {this.state.initDone &&
                    <Modal title="分配任务" visible={this.props.visible}
                        ...
                        footer={[
                            <Button key="back" type="primary" onClick={this.handleCancel}>分配后续任务</Button>,
                    ...
                    >
                        <div className={style.DistributeModal}>
                            <div className={style.function}>
                                <SelectPlanTopBtn></SelectPlanTopBtn>
