...
class Calend extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        // console.log(nextProps.exceptionData)
    ...
    changeColor(e, v) {
        if (e.target.style.backgroundColor == 'rgb(206, 226, 246)') {
            e.target.style.backgroundColor = '#edecec'
        } else if (e.target.style.backgroundColor == 'rgb(237, 236, 236)') {
            ...
            <div className={style.acmhj}>
                    ...
                    return (
                        <div className={style.data} key={index}>
                            <table>
                                <tbody>
                                    <tr>
                                        <td colSpan={7} className={style.day} height={24} align='center'>{index + 1}月</td>
                                    </tr>
                                                    ...
                                                    val.map((childitem, childindex) => {
                                                        return childitem == '' ? (
                                                            <td key={childindex} >{childitem}</td>
                                                                ...
                                                                <td key={childindex} onClick={this.changeColor.bind(this)} style={true ? { backgroundColor: '#cee2f6' } : { backgroundColor: 'red' }}>{childitem}</td>
                                                            )
                                                    })
                                                }
                                            </tr>
                ...
                {/* <div className={style.data}>
                    <table>
                        <tbody>
                            <tr>
                                <td colSpan={7} className={style.day} height={24} align='center'>1月</td>
                            </tr>
                            <tr className={style.trcontent}>
                                <td >日</td>
                                <td>一</td>
                            ...
                            {
                                this.state.onemouth.map((item, index) => {
                                    return <tr key={index} className={style.trcontent}>
                                        {
                                            this.state.onemouth[index].map((childitem, childindex) => {
                                                return childitem == '' ? (
                                                    <td key={childindex} >{childitem}</td>
                                                ) : (
                                                        <td key={childindex} month='1' onClick={this.changeColor.bind(this)} style={{ backgroundColor: '#cee2f6' }}>{childitem}</td>
                                                    )
                                            })
                                        }
                                    </tr>
                ...
                <div className={style.data}>
                    <table>
                        <tbody>
                            <tr>
                                <td colSpan={7} className={style.day} height={24} align='center'>2月</td>
                            </tr>
                            <tr className={style.trcontent}>
                                <td >日</td>
                                <td>一</td>
                            ...
                            {
                                this.state.mouth2.map((item, index) => {
                                    return <tr key={index} className={style.trcontent}>
                                        {
                                            this.state.mouth2[index].map((childitem, childindex) => {
                                                return childitem == '' ? (
                                                    <td key={childindex} >{childitem}</td>
                                                ) : (
                                                        <td key={childindex} month='2' onClick={this.changeColor.bind(this)} style={{ backgroundColor: '#cee2f6' }}>{childitem}</td>
                                                    )
                                            })
                                        }
                                    </tr>
                ...
                <div className={style.data}>
                    <table>
                        <tbody>
                            <tr>
                                <td colSpan={7} className={style.day} height={24} align='center'>3月</td>
                            </tr>
                            <tr className={style.trcontent}>
                                <td >日</td>
                                <td>一</td>
                            ...
                            {
                                this.state.mouth3.map((item, index) => {
                                    return <tr key={index} className={style.trcontent}>
                                        {
                                            this.state.mouth3[index].map((childitem, childindex) => {
                                                return childitem == '' ? (
                                                    <td key={childindex} >{childitem}</td>
                                                ) : (
                                                        <td key={childindex} month='3' onClick={this.changeColor.bind(this)} style={{ backgroundColor: '#cee2f6' }}>{childitem}</td>
                                                    )
                                            })
                                        }
                                    </tr>
                ...
                <div className={style.data}>
                    <table>
                        <tbody>
                            <tr>
                                <td colSpan={7} className={style.day} height={24} align='center'>4月</td>
                            </tr>
                            <tr className={style.trcontent}>
                                <td >日</td>
                                <td>一</td>
                            ...
                            {
                                this.state.mouth4.map((item, index) => {
                                    return <tr key={index} className={style.trcontent}>
                                        {
                                            this.state.mouth4[index].map((childitem, childindex) => {
                                                return childitem == '' ? (
                                                    <td key={childindex} >{childitem}</td>
                                                ) : (
                                                        <td key={childindex} onClick={this.changeColor.bind(this)} style={{ backgroundColor: '#cee2f6' }}>{childitem}</td>
                                                    )
                                            })
                                        }
                                    </tr>
                ...
                <div className={style.data}>
                    <table>
                        <tbody>
                            <tr>
                                <td colSpan={7} className={style.day} height={24} align='center'>5月</td>
                            </tr>
                            <tr className={style.trcontent}>
                                <td >日</td>
                                <td>一</td>
                            ...
                            {
                                this.state.mouth5.map((item, index) => {
                                    return <tr key={index} className={style.trcontent}>
                                        {
                                            this.state.mouth5[index].map((childitem, childindex) => {
                                                return childitem == '' ? (
                                                    <td key={childindex} >{childitem}</td>
                                                ) : (
                                                        <td key={childindex} onClick={this.changeColor.bind(this)} style={{ backgroundColor: '#cee2f6' }}>{childitem}</td>
                ...
                <div className={style.data}>
                    <table>
                        <tbody>
                            <tr>
                                <td colSpan={7} className={style.day} height={24} align='center'>6月</td>
                            </tr>
                            <tr className={style.trcontent}>
                                <td >日</td>
                                <td>一</td>
                            ...
                            {
                                this.state.mouth6.map((item, index) => {
                                    return <tr key={index} className={style.trcontent}>
                                        {
                                            this.state.mouth6[index].map((childitem, childindex) => {
                                                return childitem == '' ? (
                                                    <td key={childindex} >{childitem}</td>
                                                ) : (
                                                        <td key={childindex} onClick={this.changeColor.bind(this)} style={{ backgroundColor: '#cee2f6' }}>{childitem}</td>
                ...
                <div className={style.data}>
                    <table>
                        <tbody>
                            <tr>
                                <td colSpan={7} className={style.day} height={24} align='center'>7月</td>
                            </tr>
                            <tr className={style.trcontent}>
                                <td >日</td>
                                <td>一</td>
                            ...
                            {
                                this.state.mouth7.map((item, index) => {
                                    return <tr key={index} className={style.trcontent}>
                                        {
                                            this.state.mouth7[index].map((childitem, childindex) => {
                                                return childitem == '' ? (
                                                    <td key={childindex} >{childitem}</td>
                                                ) : (
                                                        <td key={childindex} onClick={this.changeColor.bind(this)} style={{ backgroundColor: '#cee2f6' }}>{childitem}</td>
                ...
                <div className={style.data}>
                    <table>
                        <tbody>
                            <tr>
                                <td colSpan={7} className={style.day} height={24} align='center'>8月</td>
                            </tr>
                            <tr className={style.trcontent}>
                                <td >日</td>
                                <td>一</td>
                            ...
                            {
                                this.state.mouth8.map((item, index) => {
                                    return <tr key={index} className={style.trcontent}>
                                        {
                                            this.state.mouth8[index].map((childitem, childindex) => {
                                                return childitem == '' ? (
                                                    <td key={childindex} >{childitem}</td>
                                                ) : (
                                                        <td key={childindex} onClick={this.changeColor.bind(this)} style={{ backgroundColor: '#cee2f6' }}>{childitem}</td>
                ...
                <div className={style.data}>
                    <table>
                        <tbody>
                            <tr>
                                <td colSpan={7} className={style.day} height={24} align='center'>9月</td>
                            </tr>
                            <tr className={style.trcontent}>
                                <td >日</td>
                                <td>一</td>
                            ...
                            {
                                this.state.mouth9.map((item, index) => {
                                    return <tr key={index} className={style.trcontent}>
                                        {
                                            this.state.mouth9[index].map((childitem, childindex) => {
                                                return childitem == '' ? (
                                                    <td key={childindex} >{childitem}</td>
                                                ) : (
                                                        <td key={childindex} onClick={this.changeColor.bind(this)} style={{ backgroundColor: '#cee2f6' }}>{childitem}</td>
                ...
                <div className={style.data}>
                    <table>
                        <tbody>
                            <tr>
                                <td colSpan={7} className={style.day} height={24} align='center'>10月</td>
                            </tr>
                            <tr className={style.trcontent}>
                                <td >日</td>
                                <td>一</td>
                            ...
                            {
                                this.state.mouth10.map((item, index) => {
                                    return <tr key={index} className={style.trcontent}>
                                        {
                                            this.state.mouth10[index].map((childitem, childindex) => {
                                                return childitem == '' ? (
                                                    <td key={childindex} >{childitem}</td>
                                                ) : (
                                                        <td key={childindex} onClick={this.changeColor.bind(this)} style={{ backgroundColor: '#cee2f6' }}>{childitem}</td>
                ...
                <div className={style.data}>
                    <table>
                        <tbody>
                            <tr>
                                <td colSpan={7} className={style.day} height={24} align='center'>11月</td>
                            </tr>
                            <tr className={style.trcontent}>
                                <td>日</td>
                                <td>一</td>
                            ...
                            {
                                this.state.mouth11.map((item, index) => {
                                    return <tr key={index} className={style.trcontent}>
                                        {
                                            this.state.mouth11[index].map((childitem, childindex) => {
                                                return childitem == '' ? (
                                                    <td key={childindex} >{childitem}</td>
                                                ) : (
                                                        <td key={childindex} onClick={this.changeColor.bind(this)} style={{ backgroundColor: '#cee2f6' }}>{childitem}</td>
                ...
                <div className={style.data}>
                    <table>
                        <tbody>
                            <tr>
                                <td colSpan={7} className={style.day} height={24} align='center'>12月</td>
                            </tr>
                            <tr className={style.trcontent}>
                                <td >日</td>
                                <td>一</td>
                            ...
                            {
                                this.state.mouth12.map((item, index) => {
                                    return <tr key={index} className={style.trcontent}>
                                        {
                                            this.state.mouth12[index].map((childitem, childindex) => {
                                                return childitem == '' ? (
                                                    <td key={childindex} >{childitem}</td>
                                                ) : (
                                                        <td key={childindex} onClick={this.changeColor.bind(this)} style={{ backgroundColor: '#cee2f6' }}>{childitem}</td>
