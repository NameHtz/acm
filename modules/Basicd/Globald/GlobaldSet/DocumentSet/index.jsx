        ...
        const formItems = keys.map((k, index) => (
            ...
            >
                {getFieldDecorator(`banFileType[${k}]`, {
                    ...
                    <Input style={{ width: keys.length > 1 ? 'calc(100% - 45px)' : 'calc(100% - 81px)' }} addonAfter={keys.length > 1 ? <Icon type="minus-circle-o" disabled={keys.length === 1} onClick={() => this.remove(k)} /> : null} />
                )}
            </Form.Item>
        ));
        return (
