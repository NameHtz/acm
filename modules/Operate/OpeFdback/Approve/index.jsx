...
export class OperateFdbackApprove extends Component {
    constructor(props) {
        super(props)
        this.state = {
            initDone: false,
    ...
    render() {
        ...
        return (
            <Modal className={style.main} width="850px" forceRender={true} centered={true}
                title="进展审批" visible={this.props.modalVisible} onCancel={this.props.handleCancel} footer={
...
const OperateFdbackApproves = Form.create()(OperateFdbackApprove)

export default OperateFdbackApproves
