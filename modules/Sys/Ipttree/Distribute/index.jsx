...
import { selectiptUsers } from '../../../../api/api'
...
//获取机构员工树
  ...
  handleOk = (e) => {
    ...
    return false;
    //   axios.post(userAdd, id, data).then(res => {
  ...
  onChange = (e) => {
    ...
    axios.post(selectiptUsers(10, 1), body).then(res => {
        ...
        >
          ...
          <div className={style.box}>
            <Table className={style.tableBox}
              ...
              rowClassName={this.setLeftClassNanpmme}
              onRow={(record, index) => {
                return {
                  onClick: (event) => {
