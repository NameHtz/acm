...
class Basic extends Component {
  ...
  componentDidMount() {
    ...
    if (this.props.submit == 'put') {
      axios.get(userInfo(this.props.selectData[0].id)).then(res => {
        console.log(res)
        var roles = []
                  ...
                  >
                    {
                      this.state.roleData.map((v, i) => {
                        return (<Option key={v.id}>{v.roleName}</Option>)
                      })
                    }
                  </Select>
                )}
            ...
            <Col span={12}>
              <Form.Item label={intl.get('wsd.i18n.sys.user1.birth')} {...formItemLayout}>
                {getFieldDecorator('birth', {
                  initialValue: this.state.info.birth ? moment(this.state.info.birth, 'YYYY-MM-DD') : null,
                  rules: [{
                    required: true,
            ...
            <Col span={12}>
              <Form.Item
                ...
                {getFieldDecorator('staffStatus', {
                  initialValue: this.state.info.staffStatus ? this.state.info.staffStatus.id.toString() : '0',
                  rules: [{
                    required: true,
                    message: intl.get('wsd.i18n.message.enter') + intl.get('wsd.i18n.sys.user1.status'),
                  }],
                })(
                  <Select>
            ...
            <Col span={12}>
              <Form.Item
                ...
                {getFieldDecorator('entryDate', {
                  initialValue: this.state.info.entryDate ? moment(this.state.info.entryDate, 'YYYY-MM-DD') : null,
                  rules: [{
                    required: true,
            ...
            <Col span={12}>
              <Form.Item
                ...
                {getFieldDecorator('quitDate', {
                  initialValue: this.state.info.quitDate ? moment(this.state.info.quitDate, 'YYYY-MM-DD') : null,
                  rules: [{
                    required: true,
            ...
            <Col span={12}>
              <Form.Item label={intl.get('wsd.i18n.sys.user1.flag')} {...formItemLayout}>
                {getFieldDecorator('flag', {
                  initialValue: this.state.info.flag,
