    ...
    render() {
        ...
        return (
            <Modal className={style.main} width="850px" forceRender={true} centered={true}
                title="分配计划" visible={this.props.modalVisible} onOk={this.handleOk} onCancel={this.props.handleCancel} bodyStyle={{ padding: 0 }} footer={[
                    <Button key="1" type="primary">分配后续任务</Button>,
                    <Button key="2" type="primary">分配紧前任务</Button>
                ]}>
