    ...
    render() {
        ...
        return (
            <Modal className={style.main} width="850px" forceRender={true} centered={true}
                title={this.props.selectType} visible={this.props.modalVisible} onCancel={this.props.handleCancel} bodyStyle={{ padding: 0 }} footer={
                    <div className="modalbtn">
                        <Button key="submit" onClick={this.props.handleCancel}>取消</Button>
